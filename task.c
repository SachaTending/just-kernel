...
void switch_task()
{
    ...
    /*
    According to https://wiki.osdev.org/James_Molloy%27s_Known_Bugs#Inline_Assembly_optimiser_problem_with_GCC_4.8, this is buggy, so this moved to process.s
    asm volatile("         \
      cli;                 \
      mov %0, %%ecx;       \
      mov %1, %%esp;       \
    ...
    */
   perform_task_switch(eip, current_directory->physicalAddr, ebp, esp); // pls work
}
